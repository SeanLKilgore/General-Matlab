%subsasgn Overload Matlab's subscript assignment method to allow the HandledStruct class to dynamically add properties as if it were a structure rather than a class
